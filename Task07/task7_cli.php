...
$number = "";
while($number != "e"){
    echo "\nEnter the number of the desired group or press 'Enter' to display information on all groups (enter 'e' to exit): ";
    $number = readline("\n");
